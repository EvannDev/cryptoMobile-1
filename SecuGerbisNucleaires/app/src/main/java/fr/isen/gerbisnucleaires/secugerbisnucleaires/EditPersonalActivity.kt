...
class EditPersonalActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        emailValue.text = email?.toString()
    ...
    private fun saveData() {
        ...
        if (firstName.isEmpty() && lastName.isEmpty() && phone.isEmpty() && password.isEmpty() && confirm1.isEmpty() && confirm2.isEmpty()) {
        ...
        } else if(confirm1.isNotEmpty() && !PASSWORD_REGEX.matches(confirm1)) {
            ...
            mAuth.signInWithEmailAndPassword(email, password)
                .addOnCompleteListener(this) { task ->
                    if (task.isSuccessful) {
                        ...
                        Toast.makeText(applicationContext, "Current password is wrong", Toast.LENGTH_LONG).show()
                    }
                }
        }
    }
